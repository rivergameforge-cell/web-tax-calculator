...
const CalcStamp = (() => {
  ...
  const REALESTATE_BRACKETS = [
    { min:           0, max:   10_000_000, tax:       0 },
    { min:  10_000_001, max:   30_000_000, tax:  20_000 },
    { min:  30_000_001, max:   50_000_000, tax:  40_000 },
    { min:  50_000_001, max:  100_000_000, tax:  70_000 },
    { min: 100_000_001, max: 1_000_000_000, tax: 150_000 },
    { min: 1_000_000_001, max: Infinity,   tax: 350_000 },
  ];

  // 인지세법 별표 제1호 (부동산 소유권 이전 계약서)
  const PROPERTY_TRANSFER_BRACKETS = [
    { min:           0, max:   10_000_000, tax:       0 },  // 1천만원 이하 비과세
    { min:  10_000_001, max:   30_000_000, tax:  20_000 },
    { min:  30_000_001, max:   50_000_000, tax:  40_000 },
    { min:  50_000_001, max:  100_000_000, tax:  70_000 },
    { min: 100_000_001, max: 1_000_000_000, tax: 150_000 },
